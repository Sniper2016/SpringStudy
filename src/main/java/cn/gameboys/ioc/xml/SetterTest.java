...
import cn.gameboys.ioc.xml.entity.Collection;
import cn.gameboys.ioc.xml.entity.PersonSetter;
import cn.gameboys.ioc.xml.setter.SelfIntroductionService;
...
public class SetterTest {
	...
	public void testBean() {
		// 根据spring配置文件创建应用上下文
		ApplicationContext context = new ClassPathXmlApplicationContext("ioc-Setter-Bean.xml");
		// 从容器中获取bean
	...
	public void testConstant() {
		// 根据spring配置文件创建应用上下文
		ApplicationContext context = new ClassPathXmlApplicationContext("ioc-Setter-Constant.xml");
		// 从容器中获取bean
	...
	public void testList() {
		// 根据spring配置文件创建应用上下文
		ApplicationContext context = new ClassPathXmlApplicationContext("ioc-Setter-List.xml");
		// 从容器中获取bean
