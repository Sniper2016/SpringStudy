...
//     * 开会之前--找个位置坐下
//     */
//    @Before("execution(* cn.gameboys.aop.annotation.ConferenceServiceImpl.conference(..))")
...
//    }
     ...
     */
    @Pointcut("execution(* cn.gameboys.aop.annotation.ConferenceServiceImpl.conference(..))")
